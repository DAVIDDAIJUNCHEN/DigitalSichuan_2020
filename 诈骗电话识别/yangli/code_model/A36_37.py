...
train_config_yml = '../configs/A36_37_config_train.yml'
test_config_yml  = '../configs/A6_37_config_test.yml'
...
for months in months_lst:
    ...
    clf_randforest = RandomForestClassifier(n_estimators=160, max_features=1, min_samples_leaf=10, max_depth=5,
    ...
    clf_gradboost = GradientBoostingClassifier(n_estimators=90, max_features=1, min_samples_leaf=20, max_depth=11,
                                               min_samples_split=50, random_state=10)
