...
from get_features_name import get_features_name_from_config
sys.path.append('../../')
...
#months_lst = [['2019-08'], ['2019-09'], ['2019-10']]
...
for months in months_lst:
    ...
    for ii in range(feature_num):
        ...
        m=mr.mutual_info_score(label_train_all,t)
        kf_lists[tt].append(m)
...
data.to_csv('特征互信息.csv', encoding='utf_8_sig')
print(999)
