...
X_train, label_train = get_usable_data(train_file, train_voc, method='idcard_cnt-avg_arpu-std_arpu-call_dur-call_type')
X_dev, label_dev = get_usable_data(dev_file, train_voc, method='idcard_cnt-avg_arpu-std_arpu-call_dur-call_type')
X_test, label_test = get_usable_data(test_file, train_voc, method='idcard_cnt-avg_arpu-std_arpu-call_dur-call_type')
