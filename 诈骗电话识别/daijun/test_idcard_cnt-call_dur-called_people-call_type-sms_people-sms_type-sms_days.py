...
X_train, label_train = get_usable_data(train_file, train_voc, train_sms, method='idcard_cnt-call_dur-called_people-call_type-sms_people-sms_type-sms_datetime')
...
X_test, phone_no_m = get_usable_data(test_file, test_voc, test_sms, get_label=False, num_month=1, get_phone_no=True, method='idcard_cnt-call_dur-called_people-call_type-sms_people-sms_type-sms_datetime')

feauture_name = 'idcard_cnt-call_dur-called_people-call_type-sms_people-sms_type-sms_datetime'
