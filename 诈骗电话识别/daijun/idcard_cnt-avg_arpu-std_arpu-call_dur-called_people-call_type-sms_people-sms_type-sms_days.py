...
X_test, label_test = get_usable_data(test_file, train_voc, train_sms, method='idcard_cnt-avg_arpu-std_arpu-call_dur-called_people-call_type-sms_people-sms_type-sms_datetime')
